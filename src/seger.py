...
default_seger_weight_path = os.path.join(package_dir,'model/universal_tiny.pth')

class Seger():
    def __init__(self,ckpt_path=default_seger_weight_path,bg_thres=200,cuda_device_id:int=0):
